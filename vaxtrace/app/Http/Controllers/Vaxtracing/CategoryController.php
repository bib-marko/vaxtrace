        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    ...
                    $actionBtn .= "<a class='update btn btn-alt-warning btn-rounded  mr-5 mb-5 btnShowSubCategory' href='".route('view_vaccinees_status_sub-category', $row->id)."'><i class='si si-list mr-5'></i>Manage Sub-Category</a>";
