      ...
      <div class="tab-pane fade fade-left show active" id="btabs-animated-slideleft-master-list" role="tabpanel">
               ...
               <div class="block">
                    <div class="block-content">
                      <form role="form" id="formCreateSub" novalidate>
                        <div class="col-lg-12">
                            <div class="row g-2">
                                <div class="col-12">
                                    <br>
                                    <div class="form-material form-material-success floating">
                                        <input class="js-maxlength form-control" id="example-material-maxlength7 home_address" type="text" name="subsystem_name"   rows="3" maxlength="100" data-always-show="true" required/>
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-2 justify-content-center ml-auto">
                            <div class="block mr-15 ml-15">
                                <button class="btn btn-square btn-alt-success min-width-120 " id="create_subsystem">Submit <span class="si si-arrow-right ms-2"> </span></button>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        $(function () {
            ...
            let validatorCreateSub = $('#formCreateSub').jbvalidator({
                    errorMessage: true,
                    successClass: false,
                });

            $('#create_subsystem').click(function (e) {
                e.preventDefault();

                var form = document.getElementById("formCreateSub");
                var formData = new FormData(form);
                if(validatorCreateSub.checkAll() == 0){
                    $.ajax({
                        url: "{{ route('subsystem.store') }}",
                        data: formData,
                        cache: false,
                        processData: false,
                        contentType: false,
