...
<div class="block">
    <ul class="nav nav-tabs nav-tabs-block" data-toggle="tabs" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" href="#btabs-animated-slideleft-master-list">Update Role/Department</a>
      </li>
      ...
      <div class="tab-pane fade fade-left show active" id="btabs-animated-slideleft-master-list" role="tabpanel">
               ...
               <div class="block">
                    <div class="block-content">
                        <form role="form" id="formUpdateRole" novalidate>
                            <div class="col-lg-12">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <br>
                                        <div class="form-material form-material-success floating">
                                            <input class="js-maxlength form-control" id="example-material-maxlength7 title" type="text" name="title" value="{{ $role->title }}" rows="3" maxlength="100" data-always-show="true"  required/>
                            ...
                            <div class="col-lg-12">
                                <div class="row g-2">
                                    <div class="col-12">
                                        <br>
                                        <div class="form-material form-material-success floating">
                                            <input class="js-maxlength form-control" id="example-material-maxlength7 short_code" type="text" name="short_code" value="{{ $role->short_code }}" rows="3" maxlength="100" data-always-show="true" required/>
                    ...
                    <div class="row text-center mt-4">
                        <div class="col-md-2 justify-content-center ml-auto">
                            <div class="block mr-15 ml-15">
                                <button class="btn btn-square btn-alt-success min-width-120 " id="update_role">Submit <span class="si si-arrow-right ms-2"> </span></button>
                            </div>
                        </div>
                    </div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        $(function () {
            ...
            let validatorUpdateRole = $('#formUpdateRole').jbvalidator({
                    errorMessage: true,
                    successClass: false,
            });
            var data = {!! json_encode($role) !!};
